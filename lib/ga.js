...
GA.prototype.getSegments = function(options, cb) {
    var self = this;
    var data_url = 'https://www.googleapis.com/analytics/v3/management/segments?' + querystring.stringify(options);
    ...
    var req = https.request(get_options, function(res) {
      ...
      res.on('end', function() {
        ...
        if (typeof cb === 'function' ) cb(null, parsed_data);
      });
    });
    req.end();
}

GA.prototype.getProfiles = function(options, cb) {
    var self = this;

    var accountId = options.accountId || '~all';
    var webPropertyId = options.webPropertyId || '~all';

    var data_url = 'https://www.googleapis.com/analytics/v3/management/accounts/'+accountId+'/webproperties/'+webPropertyId+'/profiles';
...
GA.prototype.getAccounts = function(options, cb) {
    var self = this;
    var data_url = 'https://www.googleapis.com/analytics/v3/management/accounts';
...
GA.prototype.getProperties = function(options, cb) {
    var self = this;
    var accountId = options.accountId || '~all'
    var data_url = 'https://www.googleapis.com/analytics/v3/management/accounts/'+accountId+'/webproperties';
